...
public class Playable : MonoBehaviour
{
   ...
   // public GameObject livingAttributes;
   // public Script livingAttributes;
   ...
   // }
    ...
    {
        //onky if no player object i guess
        //player = new GameObject("player");
        livingAttribute = GameObject.find("player").GetComponent<Living>()
        print("test");
